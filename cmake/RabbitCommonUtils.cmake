...
function(GET_VERSION)
    ...
    IF(EXISTS "${PARA_SOURCE_DIR}/.git")
        ...
        IF(GIT)
            ...
            ENDIF()
            IF(DEFINED PARA_OUT_VERSION AND _OUT_VERSION)
                string(REPLACE "v" "" _OUT_VERSION ${_OUT_VERSION})
                SET(${PARA_OUT_VERSION} ${_OUT_VERSION} PARENT_SCOPE)
            ENDIF()
            IF(DEFINED PARA_OUT_REVISION AND _OUT_REVISION)
...
#                    DESTINATION ${ANDROID_BUILD}/)
            add_custom_command(
                TARGET ${PARA_NAME} POST_BUILD
                COMMAND ${CMAKE_COMMAND} -E echo "copy directory ${CMAKE_BINARY_DIR}/assets to ${ANDROID_BUILD}/assets"
                COMMAND ${CMAKE_COMMAND} -E copy_directory "${CMAKE_BINARY_DIR}/assets" "${ANDROID_BUILD}/assets"
                COMMENT "Copy directory ${CMAKE_BINARY_DIR}/assets/ to ${ANDROID_BUILD}/assets"
                COMMAND_EXPAND_LISTS
                VERBATIM)
